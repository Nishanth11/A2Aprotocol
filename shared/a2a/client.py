...
from shared.models.request import SendTaskRequest, GetTaskRequest  # Removed CancelTaskRequest

# Base request format for JSON-RPC 2.0
from shared.models.json_rpc import JSONRPCRequest

# Models for task results and agent identity
from shared.models.task import Task, TaskSendParams
