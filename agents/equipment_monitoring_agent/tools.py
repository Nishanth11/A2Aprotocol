import asyncio
from agents.equipment_monitoring_agent.dummy_opc_ua import get_material_availability, get_machine_states
# To use a real OPC UA server, replace the line above with:
# from agents.equipment_monitoring_agent.opcua_data_access import get_material_availability, get_machine_states
